...
func (m *SnippetModel) Get(id int) (*models.Snippet, error) {
	...
	// columns returned bu your statement.
...
func (m *SnippetModel) Latest() ([]*models.Snippet, error) {
	...
	// We defer rows.Close() to ensure the sq.Rows resultset is
	...
	// rows.Scan() method. If iteration over all the rows complets then the
	...
	for rows.Next() {
		...
		// new Snippet object that we created. Agains, the arguments to row.Scan()
